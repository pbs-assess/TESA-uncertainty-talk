...
set.seed=42
boxplot(rlnorm(1000, log(40), 0.7), xlab="complete box", horizontal=TRUE, add=TRUE, at=0.02, width=0.005)
...
plot(xvalslog, yvalslog, col="red", lwd=3,
     ...
     xlab="Weight, g", ylab="Probability density", xaxs="i", yaxs="i")
boxplot(rlnorm(1000, log(40), 0.7), xlab="complete box", horizontal=TRUE, add=TRUE, at=0.025, boxwex=0.01,
     outline=FALSE     )
