...
\begin{tabular}{lrrrr}
  ...
  & & & & \\
Probability that a tossed coin lands heads: & $\dfrac{1}{2}$ & \alert<3-4>{0.5} & \textcolor<4>{blue}{50\%} & 1 in
                                                                             2 \\
  & & & & \\
\onslide<2->Probability that a rolled die gives a six: & $\dfrac{1}{6}$ & \alert<3-4>{0.167} & \textcolor<4>{blue}{16.7\%} & 1 in
                                                                            6
\end{tabular}
\includegraphics<2->[height=1cm, right]{images/die-roll.png}
...
df = tibble("Annual catch strategy (t)" = seq(0, 1000, 200),
            "2018" = rep(0.87, 6),
            "2019" = c(0.88, 0.88, 0.87, 0.86, 0.86, 0.85),
            "2020" = c(0.90, 0.89, 0.88, 0.86, 0.85, 0.83),
            "2021" = c(0.92, 0.90, 0.88, 0.86, 0.85, 0.83),
            "2022" = c(0.93, 0.91, 0.89, 0.87, 0.85, 0.82),
            "2023" = c(0.94, 0.92, 0.90, 0.87, 0.85, 0.81)
            )
...
**May well move to after some results - motivation for how do we do these
calculations. If move then repeat an earlier slide.
...
\textcolor{blue}{infer how the system works}.
