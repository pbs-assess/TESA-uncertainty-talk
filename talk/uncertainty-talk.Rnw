...
\begin{frame}
\frametitle{Bridging to the base model: update SS and
...
\section{Ooh -- a colour figure!}
\begin{frame}
\frametitle{Bridging to the base model: fishery and survey data}
  \bc
  % Replacing knitr chunk with resulting figures
  \includegraphics[height=3in]{images/bridge_biomass2-1.eps}
  \ec
\end{frame}
