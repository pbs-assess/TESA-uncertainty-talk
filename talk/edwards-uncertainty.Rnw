...
df = tibble("Annual catch strategy (t)" = seq(0, 1000, 200),
            "2020" = rep(0.87, 6),
            "2021" = c(0.88, 0.88, 0.87, 0.86, 0.86, 0.85),
            "2022" = c(0.90, 0.89, 0.88, 0.86, 0.85, 0.83),
            "2023" = c(0.92, 0.90, 0.88, 0.86, 0.85, 0.83),
            "2024" = c(0.93, 0.91, 0.89, 0.87, 0.85, 0.82),
            "2025" = c(0.94, 0.92, 0.90, 0.87, 0.85, 0.81)
            )
